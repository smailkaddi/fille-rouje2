    ...
    <Fragment>
      <div className="col-span-1 overflow-auto bg-white shadow-lg p-4">
        <table className="table-auto border w-full my-2">
          <thead>
            <tr>
              ...
              <th className="px-4 py-2 border">Créé </th>
              <th className="px-4 py-2 border">Mis à jour</th>
          ...
          <tbody>
            {products && products.length > 0 ? (
              ...
              <tr>
                ...
                >
                  No product foundAucun produit trouvé
        ...
        <div className="text-sm text-gray-600 mt-2">
          Total {products && products.length} produit trouvé

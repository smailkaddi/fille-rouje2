      ...
      <nav className="fixed top-0 w-full z-10 shadow-lg lg:shadow-none bg-white">
        <div className="m-4 md:mx-12 md:my-6 grid grid-cols-4 lg:grid-cols-3">
          <div className="hidden lg:block col-span-1 flex text-gray-600 mt-1">
            <span
              className="hover:bg-gray-200 px-4 py-3 rounded-lg font-light tracking-widest hover:text-gray-600 cursor-pointer text-gray-600 font-serif"
            ...
            <span
              className="hover:bg-gray-200 px-4 py-3 rounded-lg font-light tracking-widest hover:text-gray-800 cursor-pointer text-gray-600 font-serif"
          ...
          >
           <img src={logo} alt="Lgo"  className=" h-10 m-auto 	"/>
          </div>
          <div className="flex items-right col-span-2 lg:col-span-1 flex justify-end">
            ...
            >
              ...
              <span className="absolute top-0 ml-6 mt-1 bg-blue-700 rounded px-1 text-white text-xs hover:text-gray-200 font-semibold">
